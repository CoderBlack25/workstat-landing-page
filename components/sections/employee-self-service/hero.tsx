      ...
      <div className="max-w-7xl mx-auto grid grid-cols-2">
        <div className="flex flex-col gap-6">
          ...
          <h1 className="text-[52px] leading-tight text-(--midnight)">
            Give employees direct access to what they need
          </h1>
          <p className="font-medium text-(--slate-gray)">
            Employee Self-Service allows your team to manage their records,
            track activity, and access important information—without relying on
            HR for every request.
          </p>

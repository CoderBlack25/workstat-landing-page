...
const EmployeeSelfService = () => {
  return (
    <motion.section
      id="employee"
      className="w-full bg-white py-20 md:py-30 scroll-mt-30 overflow-hidden"
      initial="hidden"
      whileInView="show"
      viewport={{ once: true, amount: 0.2 }}
      variants={container}
    >
      <div className="max-w-7xl px-6 mx-auto grid grid-cols-1 lg:grid-cols-[1.5fr_2fr] items-center gap-12 lg:gap-10">
        <motion.div variants={container} className="flex flex-col space-y-4">
          ...
          <motion.h1
            variants={fadeUp}
            className="text-2xl sm:text-3xl lg:text-[32px] text-(--dark-gray) leading-snug"
          >
          ...
          <motion.h2
            variants={fadeUp}
            className="text-sm sm:text-base text-(--slate-gray)"
          >
          ...
          <motion.h3
            variants={fadeUp}
            className="text-base sm:text-lg font-medium text-(--charcoal)"
          >
          ...
          >
            <motion.ul
              variants={list}
              className="space-y-4 text-sm text-(--dark-gray)"
            >
              <motion.li
                variants={listItem}
        ...
        <motion.div
          ...
          className="bg-(--extra-light) flex justify-center items-center pt-10 sm:pt-16 lg:pt-20 order-last lg:order-0"
        >
          <Image
            src={dashboard}
            alt="Employee self-service dashboard"
            className="w-40 sm:w-56 md:w-64 lg:w-50 h-auto object-contain"
          />
        </motion.div>
      </div>
    </motion.section>

...
const hero = () => {
  return (
    <section className="bg-(--soft-cloud) pt-30 pb-40 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-2">
        <div className="flex flex-col gap-6">
          ...
          <p className="font-medium text-(--slate-gray)">
            Paystat helps you process payroll faster, reduce errors, and
            maintain clear, reliable compensation records—so you can focus on
            running your organization, not fixing payroll issues.
          </p>

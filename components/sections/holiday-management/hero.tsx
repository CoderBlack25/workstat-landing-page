      ...
      <div className="max-w-7xl mx-auto grid grid-cols-2">
        <div className="flex flex-col gap-6">
          ...
          <h1 className="text-[52px] leading-tight text-(--midnight)">
            Manage employee leave with clarity and control
          </h1>
          <p className="font-medium text-(--slate-gray)">
            Workstat allows employees to apply for leave while giving
            administrators full control over approvals and tracking.
          </p>
